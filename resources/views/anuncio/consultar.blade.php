    ...
    <div class="col">
      <div class="card">
        <div class="card-header">
          <div class="row">
            <h5 class="col" style="font-weight: bold;">
              {{ __($anuncio->inmueble->tipo->nombre.' en '.$anuncio->inmueble->calleDireccion.' '.$anuncio->inmueble->numeroDireccion.' - '.$anuncio->inmueble->comuna->nombre) }}
            </h5>
