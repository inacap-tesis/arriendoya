        ...
        <div class="row">
            <div class="col-8">
                <div class="form-group">
                    ...
                    <input class="form-check-input" type="radio" name="tipo" id="radio_{{$tipo_inmueble->id}}" value="{{$tipo_inmueble->id}}" required>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control is-invalid" id="caracteristicas" name="caracteristicas" rows="3" required></textarea>
